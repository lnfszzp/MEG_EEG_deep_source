...
- `results/real_data/ds006035/method_selection_comparison.md` 与 `results/real_data/ds004998_dbs_v2/sub-0cGdk9_HoldL_MedOn_run-1/REPORT.md`：按锁时响应或 beta 功率选择真实数据方法，并给出同任务对照与限制；两者都没有真实源位置，不能计算 AUC/DLE。
