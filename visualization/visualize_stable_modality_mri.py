...
OUT_ROOT = ROOT / "results" / "latest" / "figures" / "stable_modality_mri"
...
def main() -> None:
    render_mri_set(
        ...
        OUT_ROOT,
        row_specs,
        title_template="Stable multimodal MRI source-range reconstruction: {scenario}",
        filename_template="stable_modality_mri_{scenario}.png",
        print_label="stable MRI comparison",
    )
